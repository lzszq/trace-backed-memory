...
| PostgreSQL replay v3 schema | `schemas/postgres-v3-replay*.sql` | version-gated install, immutable/catalog/fail-closed rollback integration tests, replay protocol docs |
