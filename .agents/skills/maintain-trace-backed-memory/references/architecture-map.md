...
| GateSession completion v3 | `gate_completion_v3.py`, `sqlite_outcome_v3.py`, `schemas/sqlite-v3-outcome.sql` | atomic outcome/session write, trusted time, exact replay/read-back, schema-drift/savepoint/concurrency tests, protocol docs |
