...
- [Full Persistence execution progress](status/full-persistence-progress.json)
...
- Accepted architecture decisions:
  ...
  [ADR-0004](adr/0004-canonical-resource-manifest.md),
  [ADR-0005](adr/0005-public-internal-package-boundaries.md), and
  [ADR-0006](adr/0006-full-persistence-reducer-native-memory.md)
...
- [GateSession lifecycle events and current-state reducer v1](protocols/gate-session-events-v1.md)
- [Gate evidence events, reducers, and ledger replay export v1](protocols/gate-evidence-events-v1.md)
- [Outcome and Effect events with six deterministic reducers v1](protocols/outcome-effect-events-v1.md)
...
- [Codex Hook and App Server ingestion protocol v1](protocols/codex-ingestion-v1.md)
...
- [Governed Artifact retention and crypto-erasure v1](protocols/artifact-retention-v1.md)
- [FailureCase events and structured-evidence reducer v1](protocols/failure-case-events-v1.md)
- [MemoryCatalog events and ActivatedMemoryHead v1](protocols/memory-catalog-events-v1.md)
