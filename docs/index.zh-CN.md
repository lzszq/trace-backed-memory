...
- [Full Persistence 执行进度](status/full-persistence-progress.json)
...
- [GateSession 生命周期事件与当前状态 reducer v1](protocols/gate-session-events-v1.zh-CN.md)
- [Gate evidence 事件、reducer 与 ledger replay export v1](protocols/gate-evidence-events-v1.zh-CN.md)
- [Outcome 与 Effect 事件及六个确定性 reducer v1](protocols/outcome-effect-events-v1.zh-CN.md)
...
- [Codex Hook 与 App Server 摄取协议 v1](protocols/codex-ingestion-v1.zh-CN.md)
...
- [受治理 Artifact retention 与加密擦除 v1](protocols/artifact-retention-v1.zh-CN.md)
- [FailureCase 事件与结构化证据 reducer v1](protocols/failure-case-events-v1.zh-CN.md)
- [MemoryCatalog 事件与 ActivatedMemoryHead v1](protocols/memory-catalog-events-v1.zh-CN.md)
