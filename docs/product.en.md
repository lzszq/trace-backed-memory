...
- Use PostgreSQL 12+ and the fresh-install `schemas/postgres.sql` at schema version 1.
...
- In-place schema migration, connection pooling, and async repository access are explicit non-goals.
