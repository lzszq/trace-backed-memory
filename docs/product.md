...
- CLI structured JSON/exit-code contract、deterministic ordering、单项/批量 fresh measured completion、严格清单和 file-backed tool evidence、dry-run isolation、原子写入、batch all-or-nothing 与 module/console-script smoke；
