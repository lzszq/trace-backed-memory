...
durable HTTP/MCP and Python/TypeScript clients. The local daemon selects
SQLite only; PostgreSQL shared-service delivery, artifact-byte authorization,
attribution integration, and default
