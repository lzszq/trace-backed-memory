...
def test_current_docs_publish_postgres_v2_and_manifest_resource_contracts():
    ...
    assert "resources/manifest.json" in current_english_documents["README.md"]
    assert (
...
def test_product_and_reference_documents_are_localized_in_pairs():
    pairs = [
        ...
        (
            "docs/protocols/event-registry-v1.md",
            "docs/protocols/event-registry-v1.zh-CN.md",
        ),
        (
            "docs/protocols/event-ledger-port-v1.md",
            "docs/protocols/event-ledger-port-v1.zh-CN.md",
        ),
        (
        ...
        (
            ...
            (
                "docs/protocols/sqlite-outcome-v3.md",
                "docs/protocols/sqlite-outcome-v3.zh-CN.md",
            ),
            (
                "docs/protocols/sqlite-outcome-attribution-v3.md",
                "docs/protocols/sqlite-outcome-attribution-v3.zh-CN.md",
            ),
            (
                "docs/protocols/postgres-outcome-v3.md",
                "docs/protocols/postgres-outcome-v3.zh-CN.md",
            ),
            (
                "docs/protocols/postgres-outcome-attribution-v3.md",
                "docs/protocols/postgres-outcome-attribution-v3.zh-CN.md",
            ),
            (
                "docs/protocols/completion-outbox-v3.md",
                "docs/protocols/completion-outbox-v3.zh-CN.md",
            ),
        (
        ...
        (
            "docs/protocols/retrieval-preparation-v3.md",
            "docs/protocols/retrieval-preparation-v3.zh-CN.md",
        ),
        (
        ...
        (
            "docs/protocols/usage-decision-v3.md",
            "docs/protocols/usage-decision-v3.zh-CN.md",
        ),
        (
            "docs/protocols/durable-finalization-v3.md",
            "docs/protocols/durable-finalization-v3.zh-CN.md",
        ),
        (
...
def test_docs_publish_conservative_failure_extraction_accuracy():
    ...
    postgres_schema = _postgres_schema()
    assert "VALUES (true, 2)" in postgres_schema
    assert len(packaged_resources()) == EXPECTED_PACKAGED_RESOURCE_COUNT
...
def test_docs_publish_postgres_completion_outbox_parity():
    ...
    documents = {
        ...
        "docs/product.en.md": _doc("product.en.md"),
        "docs/product-program.md": _doc("product-program.md"),
        "docs/reference.md": _doc("reference.md"),
        "docs/protocols/completion-outbox-v3.md": _doc(
            "protocols/completion-outbox-v3.md"
        ),
    }
    for name, document in documents.items():
        normalized = " ".join(document.split()).lower()
        assert "postgres" in normalized, f"{name} must publish PostgreSQL parity"
        assert "completion outbox" in normalized or "completion-outbox" in normalized
    protocol = documents["docs/protocols/completion-outbox-v3.md"]
    for contract in (
    ...
    canonical_install = (
        ROOT / "schemas" / "postgres-v3-completion-outbox.sql"
    ).read_bytes()
    canonical_rollback = (
        ROOT / "schemas" / "postgres-v3-completion-outbox-rollback.sql"
    ).read_bytes()
    packaged_root = (
        ROOT / "src" / "trace_backed_memory" / "_resources" / "schemas"
    )
    assert (
        packaged_root.joinpath(
    ...
    assert (
        packaged_root.joinpath(
            "postgres-v3-completion-outbox-rollback.sql"
        ).read_bytes()
        == canonical_rollback
    )
    assert len(packaged_resources()) == EXPECTED_PACKAGED_RESOURCE_COUNT
