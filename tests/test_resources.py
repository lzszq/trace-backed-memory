...
def test_resource_media_types_are_deterministic():
    ...
    assert (
        by_name["schemas/postgres-v3-entity-registry.sql"].media_type
        == "application/sql"
    )
    assert (
        by_name[
    ...
    assert (
        by_name["schemas/entity_registry_v3.schema.json"].media_type
        == "application/schema+json"
    )
    assert (
    ...
    assert (
        by_name["examples/entity_registry_v3.example.json"].media_type
        == "application/json"
    )
